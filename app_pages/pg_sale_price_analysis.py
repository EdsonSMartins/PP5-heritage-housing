...
def pg_sale_price_analysis_body():
    ...
    st.write(
        ...
        f" with the Sale Price are are highlighted"
        f" in a bar plot: **{vars_to_study}**. \n"
    ...
    st.info(
        ...
        f" where the variables behave similarly "
    ...
    st.info(
        ...
        f" * Ground Level Living Area (GrLivArea):"
        f" Sale Price tends to increase "
        f" with larger living area.\n"
        f" * Garage Area (GarageArea): Sale Price"
        f" tends to increase with larger "
        f" garage area.\n"
        ...
        f" construction.\n"
        f" * 1st Floor Square Footage (1stFlrSF):"
        f" Sale Price tends to increase "
        f" with larger first floor area.\n\n"
        f"Below, scatterplots reveal the "
        f" correlation trends for each variable. "
        f" The first plot, a two-dimensional"
        f" histogram, illustrates data trends "
        f" and concentrations, with darker blue"
        f" areas indicating higher data density. "
        f" The following scatterplots, shaded "
        f" in reddish hues, show how each variable "
        f" correlates with Sale Price, emphasizing"
        f" that Overall Quality of homes tends "
        f" to rise with Sale Price. Each point’s"
        f" color represents its Overall Quality, "
        f" with darker colors indicating superior"
        f" quality. The trend of increasing Sale "
        f" Price with better Overall Quality is"
        f" prominently observed in all plots. "
