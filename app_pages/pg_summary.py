...
def pg_summary_body():
    ...
    st.info(
        ...
        f"accurately estimating house sale prices based"
        f" on different house features. "
        f"This model will empower the client to make"
        f" informed pricing decisions"
        ...
        f"Wood Deck, Year Built) along with their "
        f" sale prices. "
    )
